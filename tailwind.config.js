...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Dark theme primary colors for modern portfolio
        gray: {
          50: '#f9fafb',
          100: '#f3f4f6',
          200: '#e5e7eb',
        ...
        // Enhanced purple gradients for modern theme
        purple: {
          50: '#faf5ff',
          100: '#f3e8ff',
          200: '#e9d5ff',
        ...
        // Accent Colors - Creative & Vibrant
        accent: {
          50: '#fdf4ff',
          100: '#fae8ff',
          200: '#f5d0fe',
      ...
      backgroundImage: {
        ...
        'gradient-brand-subtle': 'linear-gradient(135deg, #f0f9ff 0%, #fdf4ff 100%)',
        'gradient-hero': 'linear-gradient(135deg, #0ea5e9 0%, #7c3aed 50%, #d946ef 100%)',
        'gradient-card': 'linear-gradient(145deg, #ffffff 0%, #f8fafc 100%)',
        'gradient-dark': 'linear-gradient(135deg, #0c4a6e 0%, #4a044e 100%)',
        // Modern dark theme gradients
        'gradient-dark-hero': 'linear-gradient(135deg, #111827 0%, #581c87 50%, #111827 100%)',
        'gradient-dark-card': 'linear-gradient(145deg, #1f2937 0%, #374151 100%)',
        ...
        'gradient-red-pink': 'linear-gradient(135deg, #ef4444 0%, #ec4899 100%)',
      },
      boxShadow: {
        'brand': '0 4px 14px 0 rgba(14, 165, 233, 0.15)',
        'brand-lg': '0 10px 40px 0 rgba(14, 165, 233, 0.2)',
        'accent': '0 4px 14px 0 rgba(217, 70, 239, 0.15)',
        'accent-lg': '0 10px 40px 0 rgba(217, 70, 239, 0.2)',
